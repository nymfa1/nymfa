      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage(
                "assets/BPolos.jpg"), // Ganti dengan path ke gambar latar belakang
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
            ...
            Container(
              ...
              child: const CircleAvatar(
                ...
                backgroundImage: AssetImage(
                    'assets/avm.jpg'), // Ganti dengan path ke gambar profil
              ),
            ),
            const SizedBox(height: 20),
            const Text(
              "Nama: Arivian Mujahid",
    ...
    return GridView.count(
      ...
      children: <Widget>[
        ...
        DashboardIcon(
          ...
          label: "Alamat", // Tambahkan label sesuai ikon
        ),
